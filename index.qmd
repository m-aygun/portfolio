...
pacman::p_load("rvest", "purrr", "data.table", "stringr", "tidyr", "zoo",
               ...
               "fueleconomy", "viridis", "boot", "glmnet", "pls", "tidyverse", "dplyr","corrplot")
...
Data is imported by API-call and webscrabing. All the data is public available. Data is imported from DMI, DST, kalender365.dk and www.superstats.dk. By the end dataset fare merged and cleaned in order to do the statistical analysis. Different variables are added in order to perform explorative analysis.
